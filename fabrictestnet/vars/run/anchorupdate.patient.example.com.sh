...
jq '.channel_group.groups.Application.groups."patient-example-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer2.patient.example.com","port": 7051}]},"version": "0"}}' hospital_current_config.json > hospital_modified_anchor_config.json
