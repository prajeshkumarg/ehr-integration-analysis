...
let oked=0
let total=0
declare -a allpeernodes=(peer1.doctor.example.com peer2.doctor.example.com peer1.patient.example.com peer2.patient.example.com peer1.hospadmin.example.com)
